...
Hey, this repository contains files related to the projects.

## Salary Dashboard
This data job salary dashboard is created to help job seekers investigate their desired jobs and ensure they are paid fairly.
[checkout_my_work_here](Project_1-Dashboard)

<img width="1347" height="619" alt="1_Salary_Dashboard" src="https://github.com/user-attachments/assets/e345f39e-9fcc-43f5-9001-d66d0f89d951" />

## Salary Analysis
This dashboard provides insights into salaries for various data science jobs. It helps job seekers explore the skills required for different roles, understand which skills are in demand, and see which positions offer higher compensation.   
[checkout_my_work_here](Project_2-Analysis)
